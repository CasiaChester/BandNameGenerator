...
app.post("/submit", (req, res) => {
  ...
  let randAdj = Math.floor(randomNumber * adj.length);
  let randnoun = Math.floor(randomNumber * adj.length);
  let pickedAdj = adj[randAdj];
  let pickedNoun = noun[randnoun];

  console.log(pickedNoun);
  console.log(pickedAdj);
